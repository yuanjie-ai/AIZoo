...
from aizoo.tab.autofeat.primitives import *

import featuretools as ft
import featuretools.variable_types as vt

from tqdm.auto import tqdm
from meutils.pd_utils import reduce_mem_usage, duplicate_columns
...
class AutoFeat(object):
    ...
    def _reduce_feats(self, df):
        df.drop(duplicate_columns(df), 1, inplace=True)  # todo: 增加单值
        return df
